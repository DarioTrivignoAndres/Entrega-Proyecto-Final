...
namespace WebApplication2
{
    ...
    public static class ADO_Usuario
    {
        ...
        public static Usuario InicioDeSesion(string nombreUsuario, string contraseña)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                using (SqlCommand sqlCommand = new SqlCommand("SELECT * FROM [SistemaGestion].[dbo].[Usuario] " +
        ...
        public static bool ModificarUsuario(Usuario usuario)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(connectionString))
            {
                string queryUpdate = "UPDATE [SistemaGestion].[dbo].[Usuario],SET Nombre = @nombre, Apellido = @apellido, " +
